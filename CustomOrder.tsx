      ...
      <section className="relative py-40 overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10 text-center space-y-8">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-serif font-bold text-white leading-[0.9]"
          >
          ...
          <motion.p 
            ...
            className="text-xl font-light max-w-3xl mx-auto text-white/80 leading-relaxed"
          >
      ...
      <div className="container mx-auto px-4 -mt-20">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-24">
          ...
          <div className="lg:col-span-8">
            <form onSubmit={handleSubmit} className="bg-white/80 backdrop-blur-md border-none rounded-[60px] p-10 md:p-20 space-y-12 shadow-2xl">
