...
export default function Services() {
  ...
  if (isSubmitted) {
    return (
      <div className="pt-32 pb-24 container mx-auto px-4 max-w-2xl text-center space-y-8">
        ...
        <h1 className="text-4xl font-serif font-bold">Demande Envoyée</h1>
  ...
  return (
    <div className="pt-24 pb-24">
      {/* Hero */}
      <section className="relative py-40 overflow-hidden min-h-[60vh] flex items-center">
        ...
        <div className="container mx-auto px-4 text-center space-y-8">
          ...
          <motion.h1 
            ...
            className="text-6xl md:text-8xl font-serif font-bold leading-[0.9]"
          >
          ...
          {services.map((service, index) => (
            ...
            >
              <Card className="h-full border-none shadow-2xl hover:shadow-primary/10 transition-all duration-700 rounded-[50px] overflow-hidden group bg-white/80 backdrop-blur-md">
                <CardContent className="p-12 flex flex-col h-full space-y-10">
