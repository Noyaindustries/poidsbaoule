...
export default function Story() {
  return (
    <div className="min-w-0 max-w-[100vw] overflow-x-clip pb-16 pt-20 sm:pb-24 sm:pt-24">
      {/* Hero */}
      <section className="relative flex min-h-[45vh] items-center justify-center overflow-hidden sm:min-h-[60vh]">
        ...
        <div className="container relative z-10 max-w-full space-y-3 px-3 text-center text-white sm:space-y-4 sm:px-4">
          <h1 className="text-3xl font-serif font-bold sm:text-5xl md:text-7xl">Notre Histoire</h1>
          <p className="text-sm font-light uppercase tracking-widest opacity-80 sm:text-lg md:text-xl">
            L'âme de l'artisanat Ivoirien
          </p>
        </div>
      </section>

      <div className="container mx-auto mt-16 max-w-full px-3 sm:mt-24 sm:px-4 md:px-6">
